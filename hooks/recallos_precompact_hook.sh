#!/bin/bash
# RECALLOS PRE-COMPACT HOOK — Emergency save before compaction
#
...
#       "hooks": [{
#         "type": "command",
#         "command": "/absolute/path/to/recallos_precompact_hook.sh",
#         "timeout": 30
#       }]
#     }]
#   }
...
# Set RECALLOS_DIR below if you want the hook to auto-ingest before compaction.
...
# Optional: run recallos ingest synchronously so memories land before compaction
