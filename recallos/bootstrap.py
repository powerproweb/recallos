#!/usr/bin/env python3
"""
onboarding.py Ã¢â‚¬â€ recallos first-run setup.

Asks the user:
  1. How they're using RecallOS (work / personal / combo)
  2. Who the people in their life are (names, nicknames, relationships)
  3. What their projects are
  4. What they want their domains called

Seeds the entity_registry with confirmed data so RecallOS knows your world
from minute one Ã¢â‚¬â€ before a single session is indexed.

Usage:
    python3 -m recallos.bootstrap
    or: recallos init
"""

from pathlib import Path
from recallos.entity_registry import EntityRegistry
from recallos.entity_detector import detect_entities, scan_for_detection


# Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
# Default domain taxonomies by mode
# Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
...
def _ask_mode() -> str:
    _header("Welcome to RecallOS")
    print("""
  RecallOS is a local-first AI memory operating system. To work well, it needs to know
  a little about your world Ã¢â‚¬â€ who the people are, what the projects
  are, and how you want your memory organized.

  This takes about 2 minutes. You can always update it later.
""")
    print("  How are you using RecallOS?")
    print()
    print("    [1]  Work     Ã¢â‚¬â€ notes, projects, clients, colleagues, decisions")
    print("    [2]  Personal Ã¢â‚¬â€ diary, family, health, relationships, reflections")
    print("    [3]  Both     Ã¢â‚¬â€ personal and professional mixed")
    print()
...
def _ask_people(mode: str) -> tuple[list, dict]:
    ...
    people = []
    aliases = {}  # nickname Ã¢â€ â€™ full name

    if mode in ("personal", "combo"):
        _hr()
        print("""
  Personal world Ã¢â‚¬â€ who are the important people in your life?
...
""")
    ...
    if mode in ("work", "combo"):
        _hr()
        print("""
  Work world Ã¢â‚¬â€ who are the colleagues, clients, or collaborators
...
def _ask_projects(mode: str) -> list:
    ...
    _hr()
    print("""
  What are your main projects? (These help RecallOS distinguish project
  names from person names Ã¢â‚¬â€ e.g. "Lantern" the project vs. "Lantern" the word.)
...
def _ask_domains(mode: str) -> list:
    defaults = DEFAULT_DOMAINS[mode]
    _hr()
    print(f"""
  Domains are the top-level categories in your Data Vault.

  Suggested domains for {mode} mode:
    {", ".join(defaults)}

  Press enter to keep these, or type your own comma-separated list.
""")
    custom = input("  Domains: ").strip()
    if custom:
...
def _warn_ambiguous(people: list) -> list:
    ...
    """
    from recallos.entity_registry import COMMON_ENGLISH_WORDS
...
def _generate_recallscript_bootstrap(
    people: list, projects: list, domains: list, mode: str, config_dir: Path = None
):
    """
    Generate RecallScript entity registry + critical facts bootstrap from onboarding data.
    These files teach the AI about the user's world from session one.
    """
    recallos_dir = Path(config_dir) if config_dir else Path.home() / ".recallos"
    recallos_dir.mkdir(parents=True, exist_ok=True)
    ...
    # RecallScript entity registry
    registry_lines = [
        "# RecallScript Entity Registry",
        "# Auto-generated by recallos init. Update as needed.",
        "",
        "## People",
    ]
    for p in people:
    ...
    (recallos_dir / "recallscript_entities.md").write_text("\n".join(registry_lines))

    # Critical facts bootstrap (pre-palace Ã¢â‚¬â€ before any mining)
    facts_lines = [
        "# Critical Facts (bootstrap Ã¢â‚¬â€ will be enriched after mining)",
        "",
    ]
    ...
    facts_lines.extend(
        [
            ...
            f"Mode: {mode}",
            "",
            "*This file will be enriched after ingesting your files.*",
        ]
    )

    (recallos_dir / "critical_facts.md").write_text("\n".join(facts_lines))
...
def run_onboarding(
    ...
    if auto_detect and _yn("\nScan your files for additional names we might have missed?"):
        ...
        if detected:
            ...
            if _yn("  Add any of these to your registry?"):
                for e in detected:
                    ans = input(f"    {e['name']} Ã¢â‚¬â€ (p)erson, (s)kip? ").strip().lower()
                    if ans == "p":
                        ...
                        ctx = (
                            ...
                            if mode == "personal"
                                ...
                                "work"
                                if mode == "work"
                                else input("    Context Ã¢â‚¬â€ (p)ersonal or (w)ork? ")
                                .strip()
                                .lower()
                                .replace("w", "work")
                                .replace("p", "personal")
  ...
  recallos will check the context before treating them as person names.
  For example: "I picked up Riley" Ã¢â€ â€™ person.
               "Have you ever tried" Ã¢â€ â€™ adverb.
""")
    ...
    # Generate RecallScript entity registry + critical facts bootstrap
    _generate_recallscript_bootstrap(people, projects, domains, mode, config_dir)
    ...
    print("\n  RecallScript entity registry: ~/.recallos/recallscript_entities.md")
    print("  Critical facts bootstrap: ~/.recallos/critical_facts.md")
