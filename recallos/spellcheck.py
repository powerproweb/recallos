#!/usr/bin/env python3
"""
spellcheck.py â€” Spell-correct user messages before vault filing.
...
Corrects:
  ...
  - Common fat-finger words (3am â†’ 3am, knoe â†’ know)

Usage:
    from recallos.spellcheck import spellcheck_user_text
    corrected = spellcheck_user_text("lsresdy knoe the question befor")
    # â†’ "already know the question before"  (best effort)
"""
...
# Lazy-load autocorrect â€” not everyone has it installed
_speller = None
_autocorrect_available = None

# System word list â€” loaded once, used to skip already-valid words
...
# CamelCase: ChromaDB, recallos, LongMemEval
...
# Very short tokens â€” skip (I, a, ok, my, etc. â€” also avoids ambiguous 3-char typos
...
# â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
# Edit distance â€” used to guard against over-aggressive autocorrect
# â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
def spellcheck_user_text(text: str, known_names: Optional[set] = None) -> str:
    ...
    if speller is None:
        return text  # autocorrect not installed â€” pass through unchanged
    ...
    def _fix(match):
        ...
        # Skip words that are already valid English â€” prevents "coherently" â†’ "inherently"
...
if __name__ == "__main__":
    test_cases = [
        ...
        "recallos cant be fine-tunned if you alredy kno the question",
    ...
    for msg in test_cases:
        result = spellcheck_user_text(msg, known_names={"riley", "sam", "recallos"})
        changed = " â† CHANGED" if result != msg else ""
        print(f"\nIN:  {msg}")
        if result != msg:
